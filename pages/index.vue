...
export default {
  ...
  data () {
    return {
      ...
      opportunities: [
        { id: 1, title: '1€ dépensé = 1 point gagné', location: 'dans tous les commerces partenaires', link: 'Je commande', src: 'https://evoclip.fr/c/19-category_default/logos-grande-distribution-gms.jpg' },
                      ...
                      <div class="flex justify-center">
                        <div class="flex relative w-full justify-center items-center">
                          <div class="w-full overflow-hidden">
                            <ol v-if="store.token && store.user.role === 'ROLE_CLIENT'" id="list" class="flex relative w-full m-0 p-0">
                            ...
                            <ol v-else id="list" class="flex relative w-full m-0 p-0">
                              <li v-for="op in opportunities" id="advantage" :key="op.id" class="flex mx-2 my-0 grow-0 shrink-0 basis-auto">
                                <NuxtLink class="block box-border w-full h-full overflow-hidden pointer-events-auto rounded-xl isolate cursor-pointer">
                                  <div class="relative w-full h-full min-h-0">
                                    <div class="flex top-0 h-full left-0 right-0 bottom-0 bg-teal/50">
                                      <div class="flex flex-col grow shrink basis-0 box-border relative h-full p-4 justify-between items-start">
                                        <div class="w-full">
                                          <div class="cursor-pointer pointer-events-auto tracking-tight text-lg leading-6 font-semibold">
                                            <div class="line-clamp-3">
                                      ...
                                      <div id="image" class="relative grow-0 shrink-0 basis-auto">
                                        <img class="w-full object-cover top-0 absolute h-full" :src="op.src">
                                      </div>
                                    </div>
                                  </div>
                                </NuxtLink>
